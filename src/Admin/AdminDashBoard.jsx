...
export default function AdminDashBoard() {
  ...
  const admingetdata = (page) => {
    setLoad(true);
    axios
      .get(`https://project-json.onrender.com/products?_limit=5&_page=${page}`)
      .then((res) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(`https://project-json.onrender.com/products`, formData)
      .then((response) => {
  ...
  const handleEditFormSubmit = (e) => {
    e.preventDefault();
    axios
      .put(`https://project-json.onrender.com/products`, editdata)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
