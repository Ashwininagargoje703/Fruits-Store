    ...
    <div>
      ...
      <div className="bg-white w-72 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        ...
        <div className="px-4 py-3 w-72">
          <div className="center relative inline-block select-none whitespace-nowrap rounded-full bg-blue-500 py-1 px-2 align-baseline font-sans text-xs font-bold uppercase leading-none text-white">
            <RouterLink to={`/productdiscription/${id}`}>
              <div className="rounded-full">Details</div>
            </RouterLink>
          </div>
          ...
          <div className="w-full">
            <button
              ...
              className=" w-full mr-2 mb-4 flex cursor-pointer items-center justify-center rounded-md bg-green-600 hover:bg-emerald-700 py-2 px-8 text-center text-white transition duration-150 ease-in-out hover:translate-y-1 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
